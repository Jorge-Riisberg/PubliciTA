...
class EmpresaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $empresas = $em->getRepository('MainBundle:Empresa')->findAll();
    ...
    {
        $empresa = new Empresa();
        $form = $this->createForm('MainBundle\Form\EmpresaType', $empresa);
    ...
    {
        $deleteForm = $this->createDeleteForm($empresa);
        $editForm = $this->createForm('MainBundle\Form\EmpresaType', $empresa);
